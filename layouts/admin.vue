...
const navGroups = computed(() => [
  ...
  {
    label: t('adminNav.management'),
    items: [
      { to: '/admin/accueil', label: t('adminNav.homeBanner'), icon: 'image' },
      { to: '/admin/utilisateurs', label: t('adminNav.users'), icon: 'users' },
      { to: '/admin/organisateurs', label: t('adminNav.organizers'), icon: 'briefcase' },
      { to: '/admin/evenements', label: t('adminNav.events'), icon: 'calendar' },
      { to: '/admin/categories', label: t('adminNav.categories'), icon: 'tag' },
      { to: '/admin/demandes', label: t('adminNav.editRequests'), icon: 'edit', badge: pendingRequestsCount },
      { to: '/admin/messages', label: t('adminNav.contactMessages'), icon: 'mail', badge: unreadMessagesCount },
      { to: '/admin/billets', label: t('adminNav.tickets'), icon: 'ticket' },
      { to: '/admin/commandes', label: t('adminNav.orders'), icon: 'clipboard' },
      { to: '/admin/paiements', label: t('adminNav.payments'), icon: 'card' },
    ],
  },
])
