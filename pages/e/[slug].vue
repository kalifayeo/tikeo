...
<template>
  <div>
    ...
    <template v-else-if="event">
      ...
      <!-- Barre sticky mobile -->
      <div v-if="hasAvailableTickets" class="sticky bottom-0 z-30 flex items-center justify-between gap-3 border-t border-tikeo-border bg-tikeo-surface px-4 py-3 md:hidden">
        <div>
